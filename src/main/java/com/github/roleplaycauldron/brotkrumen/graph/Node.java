 ...
 * @param graphId the id of the node
 * @param x       the x coordinate of the node
 * @param y       the y coordinate of the node
 * @param z       the z coordinate of the node
 */
@SuppressWarnings("PMD.ShortVariable")
public record Node(int dbId, int graphId, int x, int y, int z) {

    /**
     * A constructor using the x, y and z coordinates.
     *
     * @param graphId the id of the node within the graph
     * @param x       the x coordinate of the node
     * @param y       the y coordinate of the node
     * @param z       the z coordinate of the node
     */
    public Node(final int graphId, final int x, final int y, final int z) {
     ...
     */
    public Node(final int dbId, final int graphId, final Location loc) {
     ...
     * @param loc     the {@link Location} of the node
     */
    public Node(final int graphId, final Location loc) {
        this(-1, graphId, loc);
    }
}
